    ...
    render() {
        return(
            <footer className={containerStyles.footer}>
                ...
                <a href="https://wisniowasu.pl" className={containerStyles.logo}></a>
                <div className={containerStyles.icons}>
                <a className={containerStyles.facebook} href="https://facebook.wisniowasu.pl" target="_blank"></a>
                <a className={containerStyles.instagram} href="https://instagram.wisniowasu.pl" target="_blank"></a>
